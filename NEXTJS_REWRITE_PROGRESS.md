...
Proof (2026-07-21, after the browser agent): `npm run lint` ✓, `npm run typecheck` ✓, `npm run test` ✓ (**589 unit**), `npm run test:integration` ✓ (**261 passed / 21 skipped**, real Postgres via Testcontainers — **no failures**), `npm run build` ✓.
